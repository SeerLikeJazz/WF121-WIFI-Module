...
#define	wifi_cmd_tcpip_set_tcp_client_port_range_id    	(((uint32)wifi_dev_type_wifi)|wifi_msg_type_cmd|0x17040000)
...
#define	wifi_rsp_tcpip_set_tcp_client_port_range_id    	(((uint32)wifi_dev_type_wifi)|wifi_msg_type_rsp|0x17040000)
...
union{
	...
	struct wifi_msg_tcpip_set_tcp_client_port_range_cmd_t     cmd_tcpip_set_tcp_client_port_range;
	...
	struct wifi_msg_tcpip_set_tcp_client_port_range_rsp_t     rsp_tcpip_set_tcp_client_port_range;
...
#define wifi_cmd_tcpip_set_tcp_client_port_range(TCP_LOCAL_PORT_RANGE_START,TCP_LOCAL_PORT_RANGE_END) \
{\
bglib_temp_msg.cmd_tcpip_set_tcp_client_port_range.tcp_local_port_range_start=(TCP_LOCAL_PORT_RANGE_START);\
bglib_temp_msg.cmd_tcpip_set_tcp_client_port_range.tcp_local_port_range_end=(TCP_LOCAL_PORT_RANGE_END);\
bglib_temp_msg.header=(((uint32)wifi_msg_type_cmd|wifi_dev_type_wifi|(((uint32)4+0)>>8)))|((((uint32)4+0)&0xff)<<8)|((uint32)0x4<<16)|((uint32)0x17<<24);\
bglib_output (4+4,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
